...
def scoreboard_write(game, r):
    ...
    score_file.write("n = ")
    score_file.write(str(game.n))
    score_file.write("\t")
    score_file.write("b = ")
    score_file.write(str(game.b))
    score_file.write("\t")
    score_file.write("l = ")
    score_file.write(str(game.s))
    score_file.write("\t")
    score_file.write("t = ")
    score_file.write(str(game.t))
    score_file.write("\t \n")
    score_file.write("2. Parameters of each player: \n")
    score_file.write("Player_O: \n")
    score_file.write("d1 = ")
    score_file.write(str(game.d1))
    score_file.write("\t")
    if game.a == True:
    ...
    score_file.write(str(game.slow_heuristic_wins))
    score_file.write(", ")
    score_file.write(str(game.slow_heuristic_wins / (2*r)))
    score_file.write("\n")
    score_file.write("Sophisticated_heuristic wins and percentage = ")
    score_file.write(str(game.sophisticated_heuristic_wins))
    score_file.write(", ")
    score_file.write(str(game.sophisticated_heuristic_wins / (2*r)))
    score_file.write("\n")
    score_file.close()
